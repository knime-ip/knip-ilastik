 ...
 */
@Plugin(type = Command.class, headless = true, menuPath = "Plugins>ilastik>Prepare Ilastik Tracking",
        description = "Creates temporary files to use for training an ilastik tracking.")
public class IlastikTrackingPredictionPrep extends ContextCommand {
